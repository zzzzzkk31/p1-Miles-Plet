...
function draw() {
  ...
  {
    if (wolkX1 > canvasx) wolkX1 = 300;
    if (wolkX2 > canvasx) wolkX2 = 330;
    if (wolkX3 > canvasx) wolkX3 = 360;
    if (wolkX4 > canvasx) wolkX4 = 500;
    if (wolkX5 > canvasx) wolkX5 = 530;
    if (wolkX6 > canvasx) wolkX6 = 560;
  }
